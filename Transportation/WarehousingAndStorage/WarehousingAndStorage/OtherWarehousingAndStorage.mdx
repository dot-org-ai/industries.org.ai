...
| retentionExpired | Storage retention period reached for stored materials |
...
```typescript
import { storeSpecialtyGoods } from '@headlessly/store-specialty-goods'

const warehouse = storeSpecialtyGoods()
