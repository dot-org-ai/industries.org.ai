...
| FurniturePadder | Wraps and protects large furniture items with moving blankets and stretch wrap |
...
| shipmentInTransitUpdated | Moving to destination |
...
```typescript
import { truckHouseholdGoods } from '@headlessly/truck-household-goods'

const mover = truckHouseholdGoods()
