...
| shipmentInTransitUpdated | En route to destination |
...
```typescript
import { truckTruckloadFreight } from '@headlessly/truck-truckload-freight'

const carrier = truckTruckloadFreight()
...
carrier.shipmentInTransitUpdated(async ({ loadId, driverId }) => {
