...
| documentsPrepared | Paperwork completed |
...
```typescript
import { flyCharterCargo } from '@headlessly/fly-charter-cargo'

const charter = flyCharterCargo()
...
charter.customsHoldPlaced(async ({ awbNumber, reason, airport }) => {
