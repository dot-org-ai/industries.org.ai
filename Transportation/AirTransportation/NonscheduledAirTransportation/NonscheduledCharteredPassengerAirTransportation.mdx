...
```typescript
import { flyCharterPassengers } from '@headlessly/fly-charter-passengers'

const charter = flyCharterPassengers()

// Find available aircraft for the route
const aircraft = await charter.findAircraft({ type: 'midsize-jet', baseAirport: 'KTEB', availableDate: '2024-07-20' })

// Check weather at destination
const weather = await charter.getWeather({ airports: ['KTEB', 'KPBI'], date: '2024-07-20' })
