...
| pipelineOperating | Oil flowing through system |
...
```typescript
import { pipePipelineTransportation } from '@headlessly/pipe-pipeline-transportation'

const pipeline = pipePipelineTransportation()
