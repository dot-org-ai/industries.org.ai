...
| screeningStats | Security screening statistics reported |
...
```typescript
import { supportAviationServices } from '@headlessly/support-aviation-services'

const aviation = supportAviationServices()
...
aviation.screeningStats(async ({ checkpoint, waitTime, forecast }) => {
