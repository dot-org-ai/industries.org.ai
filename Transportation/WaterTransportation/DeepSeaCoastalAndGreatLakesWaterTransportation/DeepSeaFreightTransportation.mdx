...
| Bosun | Leads deck crew in cargo securing, maintenance, and mooring operations |
...
```typescript
import { shipOceanFreight } from '@headlessly/ship-ocean-freight'

const carrier = shipOceanFreight()
