...
| arrivalReported | Notify port of vessel ETA |
...
| arrivalReported | Port notified of vessel estimated time of arrival |
...
```typescript
import { shipCoastalFreight } from '@headlessly/ship-coastal-freight'

const carrier = shipCoastalFreight()
...
carrier.arrivalReported(async ({ vesselId, port, eta }) => {
