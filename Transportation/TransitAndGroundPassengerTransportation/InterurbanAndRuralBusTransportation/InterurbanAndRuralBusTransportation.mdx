...
| TransportRegulator | Federal motor carrier safety oversight authority |
...
graph LR
    ...
    B -->|regulated by| TransportRegulator
...
```typescript
import { busIntercityPassengers } from '@headlessly/bus-intercity-passengers'

const busLine = busIntercityPassengers()
