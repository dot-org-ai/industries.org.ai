...
| vehicleBrokeDown | Shuttle or vanpool vehicle experienced mechanical failure |
...
```typescript
import { transportShuttlePassengers } from '@headlessly/transport-shuttle-passengers'

const transport = transportShuttlePassengers()
...
transport.vehicleBrokeDown(async ({ vehicleId, routeId, location }) => {
