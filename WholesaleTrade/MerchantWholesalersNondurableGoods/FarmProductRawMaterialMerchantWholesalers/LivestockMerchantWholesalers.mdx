...
| healthAlert | Animal health issue detected |
| priceAlert | Market price moved beyond threshold |
| certificateExpiring | Health certificate approaching expiration |
| capacityFull | Pen or yard capacity reached |
...
market.priceAlert(async ({ species, class: animalClass, price, threshold }) => {
  if (price > threshold) {
