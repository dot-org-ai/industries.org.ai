...
| complianceAlert | Regulatory requirement triggered |
| spillIncident | Chemical spill or release occurred |
...
distributor.inventoryLow(async ({ chemicalId, currentStock, reorderPoint }) => {
...
distributor.complianceAlert(async ({ reportType, dueDate, chemicals }) => {
