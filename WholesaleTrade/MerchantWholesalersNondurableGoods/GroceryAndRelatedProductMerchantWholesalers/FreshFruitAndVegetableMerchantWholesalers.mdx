...
| ripeningCompleted | Fruit reached optimal ripeness |
...
| lotExpirationNeared | Product approaching freshness limit |
...
wholesaler.inventoryDepleted(async ({ productId, currentStock }) => {
