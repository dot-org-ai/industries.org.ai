...
| stockedOut | Part unavailable in warehouse |
...
```typescript
import { wholesaleAutoParts } from '@headlessly/wholesale-auto-parts'

const wholesaler = wholesaleAutoParts()
...
wholesaler.stockDepleted(async ({ partNumber, currentQty, reorderPoint }) => {
