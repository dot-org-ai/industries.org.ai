...
| seasonChanged | Seasonal tire demand shifted |
...
```typescript
import { wholesaleTires } from '@headlessly/wholesale-tires'

const wholesaler = wholesaleTires()
...
wholesaler.seasonChanged(async ({ newSeason, region }) => {
