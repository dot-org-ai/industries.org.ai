...
| holidayNeared | Peak season coming |
...
```typescript
import { wholesaleToys } from '@headlessly/wholesale-toys'

const wholesaler = wholesaleToys()
...
wholesaler.holidayNeared(async ({ holiday, weeksOut }) => {
