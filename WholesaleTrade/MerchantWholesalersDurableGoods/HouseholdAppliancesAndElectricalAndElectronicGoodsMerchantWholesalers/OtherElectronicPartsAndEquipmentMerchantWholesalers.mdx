...
| dateCodeAging | Components approaching age limit |
| productEOL | Component end-of-life announced |
| newProductIntro | New component available |
...
wholesaler.dateCodeAging(async ({ partNumber, dateCode, ageMonths }) => {
  if (ageMonths > 24) {
