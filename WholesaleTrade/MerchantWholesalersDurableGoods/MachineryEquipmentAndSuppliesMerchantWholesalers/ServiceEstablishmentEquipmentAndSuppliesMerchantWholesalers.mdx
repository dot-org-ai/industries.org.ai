...
```typescript
import { wholesaleServiceEstablishment } from '@headlessly/wholesale-service-establishment'

const wholesaler = wholesaleServiceEstablishment()
