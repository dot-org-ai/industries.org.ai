...
| fleetAlert | Customer equipment needs attention |
...
```typescript
import { wholesaleConstructionMining } from '@headlessly/wholesale-construction-mining'

const wholesaler = wholesaleConstructionMining()
...
wholesaler.fleetAlert(async ({ customerId, serialNumber, alertType }) => {
