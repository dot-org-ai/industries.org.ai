...
| seasonStarting | Planting or harvest season approaching |
...
```typescript
import { wholesaleFarmGarden } from '@headlessly/wholesale-farm-garden'

const wholesaler = wholesaleFarmGarden()
