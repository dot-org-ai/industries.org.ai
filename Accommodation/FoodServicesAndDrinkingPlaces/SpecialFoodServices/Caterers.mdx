...
```typescript
import { caterBanquets } from '@headlessly/cater-banquets'

const caterer = caterBanquets()

// Check upcoming events and pending proposals
const upcoming = await caterer.getUpcomingEvents({ from: '2024-10-01', to: '2024-10-31' })
const pending = await caterer.getPendingProposals()
