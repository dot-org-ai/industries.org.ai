...
graph LR
    ...
    R -->|processes via| CreditCardProcessor
```
...
// Check existing reservations and table availability
const reservations = await restaurant.getReservations({ date: '2024-07-20', time: '19:00' })
const tables = await restaurant.getTableStatus({ section: 'main-dining' })
