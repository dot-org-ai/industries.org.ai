...
// Check today's arrivals and room status
const arrivals = await hotel.getArrivals({ date: '2024-06-15' })
const roomStatus = await hotel.getRoomStatus({ floor: 4, status: 'clean' })
