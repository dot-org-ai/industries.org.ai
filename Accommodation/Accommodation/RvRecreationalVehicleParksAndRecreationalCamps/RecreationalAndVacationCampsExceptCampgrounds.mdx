...
// Check available sessions and cabin capacity
const sessions = await camp.getAvailableSessions({ season: 'summer', ageGroup: '10-12' })
const cabins = await camp.getCabinAssignments({ sessionId: 'summer-adventure-week-3' })
