...
| Sonographer | Performs ultrasound examinations and captures diagnostic images |
...
// Review pending reads and modality availability
const pendingReads = await center.getPendingReads({ modality: 'MRI', urgency: 'stat' })
const modalityStatus = await center.getModalityStatus({ equipment: 'MRI-1' })
