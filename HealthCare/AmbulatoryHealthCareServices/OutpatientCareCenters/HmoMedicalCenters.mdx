...
// Review care gaps and high-risk members for outreach
const careGaps = await center.getCareGaps({ measure: 'breast-cancer-screening', year: 2024 })
const highRisk = await center.getHighRiskMembers({ riskScoreAbove: 3.0 })
