...
graph LR
    ...
    O -->|licensed by| StateHealthDepartment
```
...
// Review quality metrics and sliding fee caseload
const quality = await center.getQualityMetrics({ year: 2024, measure: 'diabetes-A1C-control' })
const slidingFee = await center.getSlidingFeePatients({ discountLevel: 'A' })
