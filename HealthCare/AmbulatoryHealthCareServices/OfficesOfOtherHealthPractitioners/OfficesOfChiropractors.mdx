...
graph LR
    ...
    C -->|bills via| AttorneyLienHolder
```
...
// Check patients due for reexam and open appointment slots
const reexamDue = await practice.getDueForReexam({ dueWithin: '7-days' })
const openSlots = await practice.getOpenSlots({ providerId: 'dr-johnson', date: '2024-03-19' })
