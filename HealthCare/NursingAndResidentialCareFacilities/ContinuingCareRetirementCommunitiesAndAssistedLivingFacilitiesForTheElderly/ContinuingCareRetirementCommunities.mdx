...
// Review occupancy levels and waitlist
const occupancy = await community.getOccupancy({ level: 'independentLiving' })
const waitlist = await community.getWaitList({ unitType: 'oneBedroomCottage' })
