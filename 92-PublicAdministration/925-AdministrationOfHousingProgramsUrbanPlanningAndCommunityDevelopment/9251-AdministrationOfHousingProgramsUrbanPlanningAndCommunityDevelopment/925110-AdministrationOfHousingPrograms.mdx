...
```typescript
import { administerAdministrationHousing } from '@headlessly/administer-administration-housing'

const housing = administerAdministrationHousing()
