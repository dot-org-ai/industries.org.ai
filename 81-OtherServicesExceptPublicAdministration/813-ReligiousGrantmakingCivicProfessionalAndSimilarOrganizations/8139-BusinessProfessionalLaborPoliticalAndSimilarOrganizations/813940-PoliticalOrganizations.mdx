...
```typescript
import { representPolitics } from '@headlessly/represent-politics'

const politicalOrg = representPolitics()
...
politicalOrg.reportDeadlineApproaching(async ({ reportType, dueDate, campaignId }) => {
