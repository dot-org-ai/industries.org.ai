...
```typescript
import { administerBanking } from '@headlessly/administer-banking'

const licensing = administerBanking()
...
licensing.renewalDue(async ({ licenseId, licensee, expirationDate }) => {
