...
| registrationExpirationNeared | Vehicle or carrier registration approaching expiration |
...
transportation.registrationExpirationNeared(async ({ registrationId, owner, vehicle }) => {
