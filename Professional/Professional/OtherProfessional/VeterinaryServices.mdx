...
```typescript
import { treatAnimals } from '@headlessly/treat-animals'

const vet = treatAnimals()

// Find patient by owner name
const patients = await vet.findPatients({ ownerName: 'Johnson', species: 'canine' })

// Check today's appointments
const appointments = await vet.getAppointments({ date: '2024-06-15', status: 'confirmed' })
