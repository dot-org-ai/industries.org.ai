...
const projects = await studio.findProjects({ status: 'in-progress', designType: 'fashion' })

// Review collection design concepts
const designs = await studio.getCollectionDesigns({ collectionId: 'spring-2025', status: 'review' })
