...
// Find available billboard and display units
const units = await ooh.findUnits({ market: 'los-angeles', type: 'digital-billboard', status: 'available' })

// Check inventory utilization
const inventory = await ooh.getInventory({ region: 'southern-california', month: '2024-08' })
