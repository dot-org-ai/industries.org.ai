...
// Monitor frac sand demand from oil and gas activity
const demand = await mine.getFracDemand({ basin: 'permian', quarter: 'Q3-2024' })

// Check silo inventory levels
const inventory = await mine.getInventory({ grade: '40/70-white', location: 'main-plant' })
