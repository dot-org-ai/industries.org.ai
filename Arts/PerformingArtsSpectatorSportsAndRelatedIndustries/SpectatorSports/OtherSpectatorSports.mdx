...
// Check current rankings and standings
const rankings = await athlete.getRankings({ tour: 'pga', year: 2024 })

// Review upcoming event schedule
const events = await athlete.getEventSchedule({ sport: 'golf', month: 6 })
