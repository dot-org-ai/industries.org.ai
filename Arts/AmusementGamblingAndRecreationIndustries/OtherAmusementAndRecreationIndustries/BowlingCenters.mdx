...
// Check lane availability for tonight
const lanes = await center.getLanes({ date: new Date(), time: 'evening' })

// View registered league schedules
const leagues = await center.getLeagues({ season: 'fall-2024' })
