...
| Event | Description |
|-------|-------------|
| facilityOperational | Station ready for service |
| satelliteTracked | Spacecraft position confirmed |
| telemetryCollected | Remote data received |
| radarOperational | Detection system active |
...
```typescript
import { operateTelecomInfrastructure } from '@headlessly/operate-telecom-infrastructure'

const facility = operateTelecomInfrastructure()
...
facility.radarOperational(async ({ facilityId, frequency }) => {
