...
| SecuritiesRegulator | Securities and Exchange Commission regulating offerings |
...
graph LR
    ...
    Vehicle -->|regulated by| SecuritiesRegulator
...
// Review existing vehicles by sponsor
const vehicles = await vehicle.findVehicles({ sponsor: 'reit-sponsor', type: 'mortgageREIT' })
