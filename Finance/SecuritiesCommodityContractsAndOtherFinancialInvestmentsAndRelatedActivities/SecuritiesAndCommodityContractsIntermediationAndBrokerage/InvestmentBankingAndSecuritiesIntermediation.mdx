...
| SecuritiesRegulator | Securities and Exchange Commission regulating markets |
...
| settleTrade | Complete transfer of securities and funds |
...
graph LR
    ...
    IB -->|regulated by| SecuritiesRegulator
    IB -->|member of| FINRA
...
// Review active deal pipeline
const deals = await bank.findDeals({ stage: 'structuring', type: 'IPO' })
...
const positions = await bank.getPositions({ security: 'AAPL', clientId: 'client-67890' })
