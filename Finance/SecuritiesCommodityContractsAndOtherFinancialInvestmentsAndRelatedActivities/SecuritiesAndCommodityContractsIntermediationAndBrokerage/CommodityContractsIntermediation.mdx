...
// Check current market prices and margin status
const prices = await fcm.getMarketPrices({ commodity: 'CL', months: ['2024-06', '2024-07'] })
const margin = await fcm.getMarginStatus({ clientId: 'client-12345' })
