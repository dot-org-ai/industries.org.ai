...
| SecuritiesRegulator | Securities and Exchange Commission regulating research and brokers |
...
graph LR
    ...
    FDP -->|regulated by| SecuritiesRegulator
...
// Check available alternative datasets
const altData = await dataProvider.getAlternativeDatasets({ category: 'sentiment' })
