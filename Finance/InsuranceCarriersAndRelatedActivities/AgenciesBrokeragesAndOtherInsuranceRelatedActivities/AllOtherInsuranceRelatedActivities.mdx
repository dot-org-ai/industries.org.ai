...
const deadlines = await consultant.getComplianceDeadlines({ state: 'CA', quarter: '2025-Q1' })

// Review pending actuarial opinions
const pending = await consultant.findPendingOpinions({ clientId: 'carrier-12345' })
