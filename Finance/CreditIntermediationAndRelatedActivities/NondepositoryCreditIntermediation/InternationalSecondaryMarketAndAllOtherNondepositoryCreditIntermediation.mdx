...
// Find available loan pools by asset class
const pools = await intermediary.findLoanPools({ assetClass: 'consumerInstallment', vintage: '2024' })
...
// Check tranche ratings before issuance
const ratings = await intermediary.getTrancheRatings({ dealId: deal.id })
