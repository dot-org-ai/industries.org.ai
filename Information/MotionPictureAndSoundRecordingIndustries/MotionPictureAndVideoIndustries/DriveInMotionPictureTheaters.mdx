...
| lotReachedCapacity | Capacity reached for showtime |
| audioBroadcastStarted | FM transmission active for soundtrack |
...
// Check capacity and upcoming schedule
const capacity = await driveIn.getCapacity({ date: '2025-07-04', screenId: 'screen-1' })
const upcoming = await driveIn.getFilmSchedule({ week: '2025-07-04' })
...
driveIn.lotReachedCapacity(async ({ showtimeId, screenId }) => {
