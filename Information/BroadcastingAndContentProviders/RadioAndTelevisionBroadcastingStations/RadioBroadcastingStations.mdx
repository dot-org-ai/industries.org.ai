...
| BroadcastRegulator | Regulates broadcast licensing and content |
...
graph LR
    ...
    S -->|reports to| BroadcastRegulator
...
```typescript
import { broadcastRadioBroadcasting } from '@headlessly/broadcast-radio-broadcasting'

const station = broadcastRadioBroadcasting()

// Check ratings and commercial schedule
const ratings = await station.getRatings({ daypart: 'morning-drive', period: '2025-Q1' })
const schedule = await station.getSchedule({ date: '2025-03-15', daypart: 'morning-drive' })
