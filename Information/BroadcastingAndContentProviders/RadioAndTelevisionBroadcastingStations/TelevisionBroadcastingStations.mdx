...
// Review ratings and affiliate feed schedule
const ratings = await station.getRatings({ daypart: 'primetime', period: '2025-February' })
const affiliateFeeds = await station.getAffiliateFeeds({ date: '2025-03-15' })
