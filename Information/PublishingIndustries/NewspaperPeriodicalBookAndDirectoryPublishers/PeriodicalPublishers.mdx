...
// Review editorial calendar and subscriber base
const calendar = await magazine.getCalendar({ year: 2025, quarter: 'Q2' })
const subscribers = await magazine.getSubscribers({ status: 'active', type: 'print-and-digital' })
