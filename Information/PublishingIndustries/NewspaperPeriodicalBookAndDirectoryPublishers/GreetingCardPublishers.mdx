...
// Review seasonal calendar and sales performance
const seasonalCalendar = await cardPublisher.getSeasonalCalendar({ upcoming: true })
const sales = await cardPublisher.getSales({ line: 'birthday', period: '2025-Q1' })
