...
| capitalAdequacyBreach | Capital ratios fell below required minimums |
...
```typescript
import { manageBankHolding } from '@headlessly/manage-bank-holding'

const bhc = manageBankHolding()
...
bhc.capitalAdequacyBreach(async ({ subsidiaryId, currentRatio, requiredRatio }) => {
