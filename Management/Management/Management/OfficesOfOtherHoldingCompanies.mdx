...
| SEC | Securities and Exchange Commission for public company compliance |
...
| fileSecuritiesReport | Submit required filings to SEC or exchanges |
...
| performanceThresholdBreach | Subsidiary missed agreed-upon KPIs |
...
```typescript
import { manageHoldingCompanies } from '@headlessly/manage-holding-companies'

const holdco = manageHoldingCompanies()
...
holdco.performanceThresholdBreach(async ({ subsidiaryId, metric, actual, target }) => {
