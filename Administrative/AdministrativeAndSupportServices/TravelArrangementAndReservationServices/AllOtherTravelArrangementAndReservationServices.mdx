...
| RoadsideDispatcher | Coordinates tow trucks and service vehicles to stranded automobile club members |
...
// Check available exchanges and member benefits
const available = await service.findExchanges({ destination: 'Hawaii', dates: '2024-12' })
const benefits = await service.getMemberBenefits({ memberId: 'owner-123' })
