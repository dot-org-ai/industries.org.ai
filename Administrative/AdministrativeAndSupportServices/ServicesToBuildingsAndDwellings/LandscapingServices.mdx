...
| Arborist | Certified tree care specialist who prunes, treats, and removes trees |
...
// Review pending estimates and today's route
const pendingEstimates = await landscape.findOpenEstimates({ daysOld: 7 })
const todayRoute = await landscape.checkSchedule({ date: '2024-04-01', crewId: 'crew-alpha' })
