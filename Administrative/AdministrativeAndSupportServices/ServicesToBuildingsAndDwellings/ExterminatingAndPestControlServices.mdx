...
| EPARegulator | Enforces pesticide use regulations |
...
```typescript
import { cleanExterminatingPest } from '@headlessly/clean-exterminating-pest'

const pestControl = cleanExterminatingPest()
