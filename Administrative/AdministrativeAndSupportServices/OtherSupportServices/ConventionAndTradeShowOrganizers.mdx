...
| ExhibitHallManager | Oversees booth assignments, floor plan layout, and decorator coordination on the show floor |
...
// Check registration stats and available booth inventory
const regStats = await events.getRegistrationStats({ eventId: 'techconnect-2024' })
const openBooths = await events.checkBoothAvailability({ eventId: 'techconnect-2024', type: 'inline' })
