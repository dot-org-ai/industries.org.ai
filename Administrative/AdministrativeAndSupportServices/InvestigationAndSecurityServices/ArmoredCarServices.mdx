...
// Check vault inventory and ATM cash levels
const vaultCash = await armored.getVaultInventory({ facility: 'main-vault' })
const atmLevels = await armored.getATMStatus({ region: 'downtown' })
