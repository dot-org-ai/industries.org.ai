...
```typescript
import { secureInvestigationPersonal } from '@headlessly/secure-investigation-personal'

const investigation = secureInvestigationPersonal()
