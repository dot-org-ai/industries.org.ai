...
| dailyCutoff | End-of-day operations period has been reached for cover and reporting |
...
```typescript
import { operateLandfill } from '@headlessly/operate-landfill'

const landfill = operateLandfill()
...
landfill.dailyCutoff(async ({ date, activeCell }) => {
