...
| PastureWalker | Rotates grazing paddocks and moves portable fencing for dual herds |
...
// Compare milk and beef revenue streams
const analysis = await farm.getRevenueAnalysis({ period: 'last-12-months' })

// Check current milk and beef market prices
const milkPrice = await farm.getMilkPrice()
const beefPrice = await farm.getBeefPrice({ class: 'feeder', weight: 600 })
