...
// Check current flock production rate and bird counts
const flock = await farm.getFlockStatus({ houseId: 'layer-house-3' })

// Review contract delivery obligations and pricing
