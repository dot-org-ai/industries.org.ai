...
// Check malting barley premium schedules
const maltPremiums = await farm.getMaltPremiums({ region: 'northern-plains' })

// Find fields suitable for barley by rotation history
const fields = await farm.findFields({ grain: 'barley', soilType: 'loam' })
