...
// Find fields suitable for soybeans by soil type
const fields = await farm.findFields({ soilType: 'loam', minAcres: 40 })

// Check current market price and basis
const pricing = await farm.getPrice({ commodity: 'soybeans', market: 'CBOT' })
