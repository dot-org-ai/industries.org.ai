...
| LeveeBuilder | Constructs and grades paddy levees and water control structures |
...
// Check water allocation for the season
const water = await farm.getWaterAllocation({ district: 'delta', season: 'spring' })

// Find fields with adequate leveling and water access
const fields = await farm.findFields({ levelingStatus: 'precision-graded', waterAccess: true })
