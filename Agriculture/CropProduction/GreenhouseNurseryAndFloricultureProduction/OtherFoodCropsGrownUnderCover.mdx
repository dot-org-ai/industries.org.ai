...
| HydroponicsTechnician | Monitors pH, EC, and nutrient solution in soilless growing systems |
...
| harvestReadied | Produce reached optimal maturity |
...
// Check environmental conditions across bays
const climate = await greenhouse.getClimateStatus({ bays: ['bay-1', 'bay-2', 'bay-3'] })

// Get current nutrient solution parameters
const nutrients = await greenhouse.getNutrientStatus({ bayId: 'bay-1' })
