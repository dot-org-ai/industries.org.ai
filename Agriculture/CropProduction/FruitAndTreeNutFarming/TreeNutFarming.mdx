...
| harvestReadied | Hulls splitting and nuts mature |
...
// Check irrigation water availability for the season
const water = await orchard.getWaterAllocation({ district: 'westlands', season: 'spring' })

// Get navel orangeworm pressure forecast
const pestForecast = await orchard.getPestPressure({ pest: 'NOW', region: 'central-valley' })
