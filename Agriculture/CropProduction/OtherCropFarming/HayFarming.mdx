...
// Check weather forecast for cutting and curing window
const weather = await farm.checkWeather({ fieldId: 'meadow-20', days: 5 })

// Get current hay prices by quality grade
const prices = await farm.getPrice({ hayType: 'alfalfa', grade: 'supreme' })
