...
// Check factory campaign schedule and delivery slots
const factory = await farm.getFactorySchedule({ processor: 'valley-sugar' })

// Get pre-harvest sugar content test results
const sugarTest = await farm.getSugarTest({ fieldId: 'river-bottom-12' })
