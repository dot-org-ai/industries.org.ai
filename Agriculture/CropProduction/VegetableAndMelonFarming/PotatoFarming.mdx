...
// Check late blight spore forecast for the region
const blightRisk = await farm.getBlightAlerts({ region: 'columbia-basin' })

// Find fields with clean disease history
const fields = await farm.findFields({ diseaseHistory: 'clean', soilType: 'sandy-loam' })
