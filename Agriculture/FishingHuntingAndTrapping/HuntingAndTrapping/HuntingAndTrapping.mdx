...
// Check open season dates and permit requirements
const seasons = await outfitter.getSeasonDates({ species: ['beaver', 'whitetail-deer'], state: 'wisconsin' })

// View upcoming guided hunt bookings
const bookings = await outfitter.getBookingCalendar({ month: 11, year: 2024 })
