...
// List upcoming camps and clinics
const camps = await academy.getCamps({ sport: 'tennis', ageGroup: 'juniors' })

// Find available lessons by instructor
const lessons = await academy.getLessons({ sport: 'tennis', week: 'next' })
