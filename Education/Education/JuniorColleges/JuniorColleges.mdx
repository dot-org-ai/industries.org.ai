...
| AdjunctProfessor | Part-time faculty teaching courses on a per-semester contract basis |
...
// List courses by subject for upcoming term
const courses = await college.getCourses({ term: 'fall-2024', subject: 'nursing' })

// Check financial aid awards by type
const aid = await college.getFinancialAid({ term: 'fall-2024', type: 'pell-grant' })
