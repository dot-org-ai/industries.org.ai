...
// Search by size, features, or price
const findHomesResult = await dealer.findHomes({ status: 'active' })

// Available configurations
const getFloorPlansResult = await dealer.getFloorPlans({ status: 'active' })
