...
| LotteryClerk | Operates lottery terminals and processes ticket sales and payouts |
...
| securityIncidentDetected | Security incident detected at store |
...
```typescript
import { retailConvenienceGoods } from '@headlessly/retail-convenience-goods'

const store = retailConvenienceGoods()
