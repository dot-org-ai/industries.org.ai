...
| DMV | State agency handling title, registration, and licensing |
...
| processTitle | Submit title and registration to DMV |
...
| titleProcessed | Registration completed with DMV |
