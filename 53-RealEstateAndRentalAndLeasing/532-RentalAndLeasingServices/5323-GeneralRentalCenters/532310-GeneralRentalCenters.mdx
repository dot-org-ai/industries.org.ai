...
| lowStockAlert | Category below minimum inventory |
...
```typescript
import { rentEquipment } from '@headlessly/rent-equipment'

const center = rentEquipment()
...
center.lowStockAlert(async ({ category, currentCount, minimumCount }) => {
