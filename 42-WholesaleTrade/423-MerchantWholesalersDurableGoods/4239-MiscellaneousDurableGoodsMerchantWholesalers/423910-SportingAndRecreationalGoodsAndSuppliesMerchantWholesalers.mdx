...
```typescript
import { wholesaleSportingRecreational } from '@headlessly/wholesale-sporting-recreational'

const wholesaler = wholesaleSportingRecreational()
