...
```typescript
import { distributeIndustrialPersonal } from '@headlessly/distribute-industrial-personal'

const distributor = distributeIndustrialPersonal()
