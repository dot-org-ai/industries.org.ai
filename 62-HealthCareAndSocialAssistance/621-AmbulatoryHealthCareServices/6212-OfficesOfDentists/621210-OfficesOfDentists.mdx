...
| recallDue | Patient is due for preventive care |
...
```typescript
import { treatDental } from '@headlessly/treat-dental'

const practice = treatDental()
...
practice.recallDue(async ({ patientId, lastVisit }) => {
