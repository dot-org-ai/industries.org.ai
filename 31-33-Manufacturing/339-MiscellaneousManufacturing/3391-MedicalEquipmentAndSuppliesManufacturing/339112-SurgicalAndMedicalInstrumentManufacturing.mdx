...
| FDA | Regulates device safety, efficacy, and manufacturing |
...
| RegulatoryAffairs | Manages FDA submissions and international registrations |
...
| Clearance | FDA 510(k) or PMA authorization to market |
...
| sterilizationComplete | Sterilization cycle validated and released |
| lotReleased | Quality authorization for distribution |
| clearanceReceived | FDA authorization obtained |
