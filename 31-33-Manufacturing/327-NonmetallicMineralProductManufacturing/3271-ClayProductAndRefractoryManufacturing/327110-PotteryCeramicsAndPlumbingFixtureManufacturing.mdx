...
| inventoryLow | Stock levels below reorder threshold |
| kilnMaintenance | Scheduled or emergency kiln service required |
...
plant.inventoryLow(async ({ materialId, currentStock, reorderPoint }) => {
