...
| palletComplete | Full pallet packed and ready for shipping |
| orderShipped | Containers delivered to customer |
| moldChange | Mold replacement completed for new product |
| machineJam | IS machine stoppage requiring intervention |
| furnaceAlert | Temperature or quality anomaly detected |
...
plant.machineJam(async ({ machineId, section, cause }) => {
