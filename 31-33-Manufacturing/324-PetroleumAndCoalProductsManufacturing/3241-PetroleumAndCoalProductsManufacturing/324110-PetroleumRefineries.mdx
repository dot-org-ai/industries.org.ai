...
| EPA | Environmental Protection Agency regulating emissions |
...
| crackingComplete | FCC or hydrocracker run finished |
...
| emissionLimit | Threshold approached or exceeded |
| equipmentAlarm | Process deviation detected |
| unitTripped | Safety shutdown activated |
| turnaroundStarted | Maintenance shutdown began |
| turnaroundComplete | Unit returned to operation |
| spillDetected | Product release identified |
| inspectionDue | Equipment inspection scheduled |
