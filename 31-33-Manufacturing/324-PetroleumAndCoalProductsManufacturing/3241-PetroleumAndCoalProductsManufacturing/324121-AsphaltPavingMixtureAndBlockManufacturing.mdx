...
| DOT | State department of transportation specifying standards |
...
| batchComplete | Single batch finished mixing |
...
| deliveryComplete | Mix delivered and accepted |
| plantShutdown | Production stopped for day or maintenance |
| tempDeviation | Mix temperature outside specification |
| specFailure | Mix failed quality test |
