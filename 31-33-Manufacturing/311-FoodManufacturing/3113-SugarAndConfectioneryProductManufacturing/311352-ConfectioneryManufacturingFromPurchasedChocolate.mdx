...
groupCode: 3113
action: Manufacture
object: Confectionery Manufacturing
---
...
```typescript
import { manufactureConfectioneryManufacturing } from '@headlessly/manufacture-confectionery-manufacturing'

const plant = manufactureConfectioneryManufacturing()
