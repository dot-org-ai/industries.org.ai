...
| Grade | USDA quality classification |
...
| grade | Evaluate and assign USDA grade |
...
| butterGraded | USDA grade assigned |
...
| findByGrade | List butter by USDA grade |
...
```typescript
import { processCreameryButter } from '@headlessly/process-creamery-butter'

const plant = processCreameryButter()
