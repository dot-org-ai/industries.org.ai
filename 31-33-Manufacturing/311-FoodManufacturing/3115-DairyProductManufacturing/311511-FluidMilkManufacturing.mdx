...
| Regulator | USDA and state dairy inspectors |
...
| SCC | Somatic cell count quality metric |
...
```typescript
import { processFluidMilk } from '@headlessly/process-fluid-milk'

const plant = processFluidMilk()
