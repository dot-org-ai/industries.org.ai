...
| USDAInspector | Conducts ante and post-mortem inspection |
...
| QualityManager | Ensures USDA compliance and food safety |
...
| InspectionMark | USDA approval stamp |
...
| inspect | Conduct USDA post-mortem inspection |
| chill | Rapidly cool carcasses |
| fabricate | Break carcass into primal cuts |
| grade | Assign USDA quality grade |
...
| carcassInspected | USDA inspection passed |
...
| getInspectionRecords | View USDA inspection results |
