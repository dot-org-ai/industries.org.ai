...
// Search garments by style and date
const availableStyles = await shop.findAvailableStyles({ category: 'tuxedo', size: '42R', date: '2024-06-15' })

// List bookings by date or customer
const reservations = await shop.getReservations({ eventDate: '2024-06-15', eventType: 'wedding' })
