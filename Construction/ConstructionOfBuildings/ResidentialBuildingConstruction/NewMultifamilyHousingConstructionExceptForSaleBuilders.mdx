...
| foundationCompleted | All foundation work finished and inspected |
| structureTopped | Structural frame reached highest point |
| roughInsCompleted | All mechanical rough-in inspections passed |
...
| amenitiesCompleted | Common area amenities ready for use |
...
builder.roughInsCompleted(async ({ projectId, building }) => {
