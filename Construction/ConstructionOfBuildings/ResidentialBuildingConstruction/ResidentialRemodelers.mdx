...
| demolitionCompleted | Tear-out phase finished |
| roughInCompleted | Framing and mechanical work finished |
...
```typescript
import { remodelResidentialRenovations } from '@headlessly/remodel-residential-renovations'

const remodeler = remodelResidentialRenovations()
...
remodeler.roughInCompleted(async ({ projectId }) => {
