...
| foundationsCompleted | Foundation work finished |
| structureCompleted | Building frame topped out |
| envelopeClosed | Building weather-tight |
| roughInCompleted | MEP rough-in inspections passed |
| interiorsCompleted | Finish work completed |
...
| punchlistCompleted | All deficiencies corrected |
...
builder.structureCompleted(async ({ projectId }) => {
...
builder.punchlistCompleted(async ({ projectId }) => {
