...
// Check lumber and truss delivery schedule
const deliveries = await framer.getDeliverySchedule({ projectId: 'custom-home-789' })

// Review crew assignments for the week
const crews = await framer.getCrewSchedule({ week: 'current' })
