...
// Check brick and block delivery schedule
const deliveries = await mason.getDeliverySchedule({ projectId: 'office-building-123' })

// Review crew assignments
const crews = await mason.getCrewSchedule({ week: 'current' })
