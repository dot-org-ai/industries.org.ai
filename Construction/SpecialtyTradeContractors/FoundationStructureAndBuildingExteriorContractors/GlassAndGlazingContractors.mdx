...
| fabricationCompleted | Frames and glass manufactured |
...
const fabrication = await glazier.trackFabricationStatus({ projectId: 'tower-project-789' })

// Review glass delivery schedule
const deliveries = await glazier.getDeliverySchedule({ projectId: 'tower-project-789' })
