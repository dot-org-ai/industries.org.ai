...
// Check fabrication status for custom metal work
const fabrication = await finisher.getFabricationStatus({ projectId: 'master-suite-789' })

// Review crew schedule for the week
const crews = await finisher.getCrewSchedule({ week: 'current' })
