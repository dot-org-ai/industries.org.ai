...
| Event | Description |
|-------|-------------|
| coordinationComplete | Drawings approved by all trades |
| plumbingRoughInComplete | Water and drain rough-in passed inspection |
| hvacRoughInComplete | Ductwork and piping installed |
...
| insulationComplete | Piping and ductwork insulated |
...
```typescript
import { installPlumbing } from '@headlessly/install-plumbing'

const mechContractor = installPlumbing()
