...
| dredgingCompleted | Underwater excavation finished |
| sheetPileInstalled | Retention wall complete |
| cofferdamDewatered | Work area dry and accessible |
| pilesCompleted | Foundation piles installed |
| concretePoursCompleted | Mass concrete placement finished |
| tunnelBrokeThrough | Tunnel excavation reached destination |
| tunnelLinedCompleted | Final lining installed |
| damCompleted | Dam structure finished |
| spillwayBecameOperational | Overflow structure tested |
| underwaterWorkCompleted | Diving operations finished |
...
contractor.damCompleted(async ({ projectId }) => {
