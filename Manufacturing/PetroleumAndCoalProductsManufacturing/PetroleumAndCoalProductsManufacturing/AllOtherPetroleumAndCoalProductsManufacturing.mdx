...
| cokingComplete | Carbonization cycle finished |
...
| blendComplete | Biodiesel blend finished |
| productTested | Quality analysis completed |
| productShipped | Order delivered to customer |
| emissionAlert | Emission threshold approached |
| ovenMaintenance | Oven scheduled for repairs |
