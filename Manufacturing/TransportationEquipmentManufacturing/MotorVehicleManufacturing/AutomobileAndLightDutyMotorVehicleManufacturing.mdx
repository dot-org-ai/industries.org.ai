...
| BodyShopTechnician | Operates robotic welding cells that join stamped body panels |
| PaintShopOperator | Manages automated paint application booths and surface prep |
