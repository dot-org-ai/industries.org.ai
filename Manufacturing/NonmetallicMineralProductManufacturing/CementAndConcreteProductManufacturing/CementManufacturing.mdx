...
| BurnerEngineer | Manages kiln burner flame shape, fuel mix, and combustion efficiency |
...
plant.kilnIssueDetected(async ({ kilnId, parameter, reading, target }) => {
...
plant.emissionsLimitExceeded(async ({ source, pollutant, reading, limit }) => {
