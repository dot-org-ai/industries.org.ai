...
| curingCompleted | Blocks reached target strength |
...
| machineWentDown | Block machine requires maintenance |
| moldChanged | Mold swap completed for different product |
...
plant.inventoryDepleted(async ({ materialId, currentLevel, reorderPoint }) => {
