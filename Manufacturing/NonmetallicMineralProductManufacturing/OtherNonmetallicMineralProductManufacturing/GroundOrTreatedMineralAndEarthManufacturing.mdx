...
| calciningComplete | Heat treatment finished |
...
| equipmentMaintenance | Mill or calciner service required |
...
```typescript
import { manufactureGroundTreated } from '@headlessly/manufacture-ground-treated'

const plant = manufactureGroundTreated()
