...
| finishingCompleted | Polishing and decoration applied |
...
| furnaceIssueDetected | Temperature or quality anomaly detected |
...
plant.furnaceIssueDetected(async ({ furnaceId, parameter, reading }) => {
