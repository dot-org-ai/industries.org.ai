...
| FDA | Regulates dental device safety and efficacy |
...
| RegulatoryAffairs | Manages FDA clearances and ADA evaluations |
...
| obtainClearance | Submit 510(k) or registration to FDA |
...
| clearanceReceived | FDA marketing authorization obtained |
...
| getRegulatoryStatus | Check FDA and ADA approval status |
