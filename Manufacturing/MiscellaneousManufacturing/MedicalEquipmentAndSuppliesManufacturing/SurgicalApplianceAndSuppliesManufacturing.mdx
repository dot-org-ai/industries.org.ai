...
| DrugRegulator | Regulates device safety and manufacturing practices |
...
| RegulatorySpecialist | Manages regulatory registrations and listings |
...
| designCompleted | Device specifications finalized |
| componentsFabricated | All parts manufactured |
| applianceAssembled | Device construction completed |
| fittingCompleted | Device adjusted to patient |
