...
| Mayonnaise | Emulsified oil-egg condiment product |
...
| QualitySpec | Target ranges for pH, viscosity, and flavor |
...
const ingredients = await plant.getIngredients({ category: 'oils', location: 'warehouse' })

// Review active batches and production schedule
