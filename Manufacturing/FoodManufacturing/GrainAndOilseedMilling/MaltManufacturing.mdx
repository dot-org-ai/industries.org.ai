...
| steepingCompleted | Barley moisture reached target level |
| germinationCompleted | Enzymes developed and modification achieved |
| kilningCompleted | Malt dried to target moisture and color |
| deculmingCompleted | Rootlets removed from malt |
...
| analysisCompleted | Quality testing finished |
...
malthouse.kilningCompleted(async ({ lotId, color, moisture }) => {
...
malthouse.analysisCompleted(async ({ lotId, results }) => {
