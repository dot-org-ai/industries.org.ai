...
| EnvironmentalRegulator | Regulates environmental emissions and waste |
...
| steepingCompleted | Corn softened and ready for processing |
...
// Check corn lot inventory and quality
const cornStock = await plant.findCornLots({ maxMoisture: 15.0, minTestWeight: 54 })
