...
| GrainGrader | Grades rice and enforces quality standards |
...
| Grade | Quality classification based on defects |
...
```typescript
import { millRice } from '@headlessly/mill-rice'

const mill = millRice()

// Check paddy inventory and current moisture levels
const paddyStock = await mill.findPaddyLots({ variety: 'longGrain', maxMoisture: 14.0 })
