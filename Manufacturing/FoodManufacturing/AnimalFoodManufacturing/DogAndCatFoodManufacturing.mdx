...
| FoodSafetyRegulator | Regulates pet food safety and labeling requirements |
| NutritionStandardsBody | Sets nutritional standards and feeding trial protocols |
...
graph LR
    ...
    M -->|follows standards of| NutritionStandardsBody
...
```typescript
import { manufactureDogCatFood } from '@headlessly/manufacture-dog-cat-food'

const plant = manufactureDogCatFood()

// Check ingredient stock levels
const ingredientStock = await plant.checkInventory({ category: 'proteins', lowStockOnly: true })
