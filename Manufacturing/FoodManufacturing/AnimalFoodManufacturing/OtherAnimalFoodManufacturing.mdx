...
| FeedSafetyRegulator | Regulates feed safety and medicated feed requirements |
...
graph LR
    ...
    M -->|regulated by| FeedSafetyRegulator
...
// Check current grain and ingredient prices
const ingredientPrices = await mill.getIngredientPrices()

// Review production schedule
const schedule = await mill.getProductionSchedule({ date: 'today' })
