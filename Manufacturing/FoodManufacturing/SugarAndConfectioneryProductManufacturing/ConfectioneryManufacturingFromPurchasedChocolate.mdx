...
| FoodSafetyRegulator | Regulates food safety and allergen labeling |
...
// Check chocolate inventory by type
const chocolateStock = await plant.findChocolateLots({ type: 'dark-64', minQuantity: 50 })
