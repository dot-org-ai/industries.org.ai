...
| heatTreatCompleted | Components have been hardened |
| grindingCompleted | Raceways are finished to specification |
| assemblyCompleted | Bearings are assembled and lubricated |
