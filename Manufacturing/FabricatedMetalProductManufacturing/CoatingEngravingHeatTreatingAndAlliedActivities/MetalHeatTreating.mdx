...
| soakComplete | Parts have reached target time and temperature |
| quenchComplete | Parts have been rapidly cooled |
| temperComplete | Tempering cycle has finished |
...
| furnaceMaintenanceDue | Equipment requires scheduled service |
