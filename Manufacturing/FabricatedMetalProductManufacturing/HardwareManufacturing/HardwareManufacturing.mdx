...
| stampingsCompleted | Stamped parts are ready for assembly |
| assemblyCompleted | Hardware items have been assembled |
| finishApplied | Plating or coating has been completed |
| functionTestPassed | Hardware has passed performance testing |
| packagingCompleted | Products are packaged and labeled |
