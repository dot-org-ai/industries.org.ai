...
| Hammersmith | Controls open-die forging hammers for custom and prototype parts |
...
| heatTreatCompleted | Thermal treatment cycle has finished |
...
| equipmentWentDown | Forging press or furnace requires unplanned maintenance |
