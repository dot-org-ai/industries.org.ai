...
| toolingComplete | Special tooling is ready |
| setupApproved | First article parts have passed inspection |
| productionRunning | Machine is producing parts at rate |
| spcAlarm | Process has gone out of control limits |
| lotComplete | Production quantity has been completed |
| orderShipped | Parts dispatched to customer |
| toolWear | Tools require replacement or adjustment |
