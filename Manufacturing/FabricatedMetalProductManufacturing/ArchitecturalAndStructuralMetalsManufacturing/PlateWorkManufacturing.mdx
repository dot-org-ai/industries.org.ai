...
| formingCompleted | Plate bending operations are done |
| assemblyFitted | Components are tacked and ready to weld |
| weldingCompleted | All welds have been completed |
| inspectionPassed | Welds have passed quality inspection |
| coatingApplied | Protective finish has been applied |
| preparedForShipment | Assembly is packaged and ready for delivery |
