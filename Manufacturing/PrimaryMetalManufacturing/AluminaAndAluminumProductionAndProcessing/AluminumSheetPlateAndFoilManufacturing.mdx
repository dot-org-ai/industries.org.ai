...
| coilLeveled | Coil flattened for sheet |
...
// List available ingot by alloy and size
const ingotStock = await mill.findIngotStock({ alloy: '3003', minWeight: 10000 })

// Check coil stock by gauge and alloy
const coilInventory = await mill.getCoilInventory({ gauge: 0.040, width: 48 })
