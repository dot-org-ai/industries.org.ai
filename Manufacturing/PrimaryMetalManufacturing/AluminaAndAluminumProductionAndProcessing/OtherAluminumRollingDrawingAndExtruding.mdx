...
// List available billets by alloy and size
const billetStock = await extruder.findBilletStock({ alloy: '6063', diameter: 7 })

// Browse available extrusion dies
const dieLibrary = await extruder.getDieLibrary({ profileType: 'structural' })
