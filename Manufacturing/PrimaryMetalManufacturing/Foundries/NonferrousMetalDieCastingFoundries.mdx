...
// List available alloy inventory
const alloyStock = await diecaster.findAlloyStock({ alloy: 'A380', minLbs: 5000 })

// Retrieve open orders by part
const orders = await diecaster.getOrders({ partNumber: 'HSG-4420', status: 'open' })
