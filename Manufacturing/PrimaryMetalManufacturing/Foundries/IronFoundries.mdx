...
```typescript
import { castIronCastings } from '@headlessly/cast-iron-castings'

const foundry = castIronCastings()

// Check available stock
const stock = await foundry.findMaterialStock({ status: 'available' })
