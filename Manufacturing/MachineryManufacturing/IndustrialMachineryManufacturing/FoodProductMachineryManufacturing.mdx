...
> Business-as-Code definition for food product machinery manufacturing operations. Models the complete production lifecycle from sanitary equipment design through food plant installation including food safety compliance and hygienic engineering.

## Overview

Food product machinery manufacturing involves producing equipment for food and beverage processing including mixers, pasteurizers, slicers, ovens, and packaging systems. Operations coordinate with stainless steel suppliers, sanitary component vendors, and food processors requiring food-safety-compliant equipment. This definition exposes actions for hygienic equipment design, sanitary fabrication, and food plant integration with events for automation and searches for compliance analytics.
...
| FoodSafetyRegulator | Oversees food safety and equipment compliance |
...
| documentCompliance | Prepare food safety and regulatory documentation |
...
| fabricationCompleted | Sanitary weldments finished |
...
| maintenanceBecameDue | Service interval reached |
...
factory.maintenanceBecameDue(async ({ equipmentId, serviceType, plantId }) => {
