...
| salesDataTracked | Retail sales performance data collected |
...
| salesDataTracked | Monitor retail performance |
...
factory.salesDataTracked(async ({ toolId, velocity, stockLevel }) => {
