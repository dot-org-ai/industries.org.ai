...
| utilizationMetricsRetrieved | Fleet usage statistics retrieved |
...
| utilizationMetricsRetrieved | Retrieve usage statistics |
...
factory.utilizationMetricsRetrieved(async ({ forkliftId, operatingHours }) => {
