...
| getConsumableUsage | Wire and electrode consumption data retrieved |
...
| getConsumableUsage | Track wire and electrode consumption |
...
// Consumable tracking
factory.getConsumableUsage(async ({ customerId, wireUsage, electrodeUsage }) => {
