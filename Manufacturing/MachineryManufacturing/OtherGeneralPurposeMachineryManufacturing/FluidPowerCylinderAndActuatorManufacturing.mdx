...
| repairHistoryRetrieved | Cylinder repair and rebuild records retrieved |
...
| repairHistoryRetrieved | Retrieve rebuild records |
...
// Rebuild program
factory.repairHistoryRetrieved(async ({ serialNumber, failureMode, operatingHours }) => {
