...
| downtimeDataRetrieved | Machine fault and stop analysis retrieved |
...
| downtimeDataRetrieved | Retrieve fault and stop analysis |
...
factory.downtimeDataRetrieved(async ({ machineId, faultHistory }) => {
