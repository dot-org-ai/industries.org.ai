...
| breakInCompleted | Conditioning finished |
| paintedAndShipped | Delivered to customer |
| systemDesignSupported | OEM circuit assisted |
| rebuildCandidatesRetrieved | Units identified for remanufacturing |
...
| rebuildCandidatesRetrieved | Identify units for reman |
...
// Search catalog
const catalog = await factory.findByPerformance()
...
factory.rebuildCandidatesRetrieved(async ({ serialNumbers, operatingHours }) => {
