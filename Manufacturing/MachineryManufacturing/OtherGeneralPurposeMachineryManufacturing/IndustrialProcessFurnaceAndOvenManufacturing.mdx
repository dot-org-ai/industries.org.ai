...
| energyUsageRetrieved | Furnace power consumption data retrieved |
...
| energyUsageRetrieved | Track power consumption |
...
// Energy optimization
factory.energyUsageRetrieved(async ({ furnaceId, kwhPerPound, benchmark }) => {
