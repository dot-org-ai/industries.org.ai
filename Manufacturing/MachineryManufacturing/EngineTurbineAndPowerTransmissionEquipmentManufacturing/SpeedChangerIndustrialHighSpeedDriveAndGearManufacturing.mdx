...
| conditionDegraded | Equipment condition degraded beyond threshold |
...
const status = await factory.getGearboxStatus()
...
factory.conditionDegraded(async ({ gearboxId, alertType, severity }) => {
