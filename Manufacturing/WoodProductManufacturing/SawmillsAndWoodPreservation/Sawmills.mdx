...
| HeadSawyer | Operates the primary headrig saw making initial breakdown cuts from logs |
| SawOperator | Operates secondary breakdown saws |
...
```typescript
import { millLumber } from '@headlessly/mill-lumber'

const mill = millLumber()
