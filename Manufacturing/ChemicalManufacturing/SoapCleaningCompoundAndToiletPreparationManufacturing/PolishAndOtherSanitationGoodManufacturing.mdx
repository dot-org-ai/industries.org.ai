...
| EPA | Registers disinfectant products |
...
| RegulatorySpecialist | Manages EPA registrations and labeling |
...
| registerProduct | Obtain EPA registration for disinfectants |
