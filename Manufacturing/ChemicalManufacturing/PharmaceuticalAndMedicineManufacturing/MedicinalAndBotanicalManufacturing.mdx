...
| DrugRegulator | Regulates drug manufacturing and GMP compliance |
...
| RegulatoryAffairs | Manages regulatory filings and compliance documentation |
...
| fileRegulatory | Submit documentation to regulatory agencies |
