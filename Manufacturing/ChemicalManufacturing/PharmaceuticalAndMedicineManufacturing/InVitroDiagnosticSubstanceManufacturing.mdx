...
| DrugRegulator | Regulates diagnostic device approval and compliance |
...
| customerComplaintReceived | Issue reported from field |
| fdaClearanceGranted | 510(k) approval received |
