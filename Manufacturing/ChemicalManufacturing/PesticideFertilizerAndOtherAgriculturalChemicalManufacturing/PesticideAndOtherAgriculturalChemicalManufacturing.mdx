...
| EPA | Registers pesticide products and oversees compliance |
...
| RegulatoryAffairs | Manages EPA registrations and label compliance |
...
| Label | EPA-approved product instructions and warnings |
| Registration | EPA approval required for product sale |
...
| verifyRegistration | Confirm EPA registration status for formulation |
...
| applyLabels | Attach EPA-compliant labels to packages |
...
| registrationConfirmed | EPA approval validated for batch |
...
| regulatoryAudit | EPA or state inspection conducted |
...
| getRegistrations | List EPA registration status and expiration |
