...
| FoodSafetyRegulator | Regulates food-grade ice production |
...
```typescript
import { manufactureIce } from '@headlessly/manufacture-ice'

const plant = manufactureIce()

// Check cold storage capacity
const storage = await plant.getInventory({ location: 'cold-storage-01' })
