...
| FoodSafetyRegulator | Regulates bottled water safety and labeling |
...
graph LR
    ...
    P -->|regulated by| FoodSafetyRegulator
...
```typescript
import { bottleBottledWater } from '@headlessly/bottle-bottled-water'

const plant = bottleBottledWater()

// Check source water quality history
const sourceHistory = await plant.getSourceHistory({ sourceId: 'mountain-spring-01' })
