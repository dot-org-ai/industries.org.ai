...
```typescript
import { bottleSoftDrinks } from '@headlessly/bottle-soft-drinks'

const plant = bottleSoftDrinks()

// Check syrup and CO2 inventory levels
const inventory = await plant.getInventory({ type: 'syrup', lowStockOnly: true })
