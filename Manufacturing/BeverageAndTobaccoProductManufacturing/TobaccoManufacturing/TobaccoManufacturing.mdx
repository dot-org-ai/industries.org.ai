...
| TobaccoRegulator | Regulates tobacco products and labeling |
...
| ComplianceManager | Manages regulatory and excise tax reporting |
...
graph LR
    ...
    M -->|sells to| Retailer
    M -->|regulated by| TobaccoRegulator
    M -->|taxed by| TTB
...
// Check leaf inventory by type and grade
const leafStock = await plant.getLeafInventory({ type: 'virginia-flue-cured', gradeMin: 'B1F' })
