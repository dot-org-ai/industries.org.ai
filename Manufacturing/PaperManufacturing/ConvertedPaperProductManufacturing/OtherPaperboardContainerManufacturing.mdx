...
| FoodContactRegulator | Oversees food contact compliance |
...
| ComplianceOfficer | Ensures food contact and safety compliance |
...
| getCompliance | Check food contact certification status |
...
graph LR
    ...
    M -->|regulated by| FoodContactRegulator
```
...
const stock = await plant.findPaperboard({ status: 'available' })
