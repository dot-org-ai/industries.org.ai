...
// List supporters
const findMembersResult = await conservancy.findMembers({ status: 'active', joinedAfter: '2024-01-01' })

// View protected lands
const getPreservesResult = await conservancy.getPreserves({ status: 'active', type: 'wetland' })
