...
// List supporters
const findMembersResult = await advocacyOrg.findMembers({ status: 'active', joinedAfter: '2024-01-01' })

// View advocacy initiatives
const getCampaignsResult = await advocacyOrg.getCampaigns({ status: 'active', year: 2024 })
