...
// View progress of order
const checkOrderStatusResult = await photoCenter.checkOrderStatus({ status: 'active' })

// View available sizes and products
const findPrintOptionsResult = await photoCenter.findPrintOptions({ status: 'active' })
