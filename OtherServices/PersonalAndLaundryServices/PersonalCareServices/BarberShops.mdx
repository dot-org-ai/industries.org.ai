...
const getClientHistoryResult = await shop.getClientHistory({ clientId: 'client-abc' })

// Check appointment availability
const findAvailableSlotsResult = await shop.findAvailableSlots({ status: 'active' })
