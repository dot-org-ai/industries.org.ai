...
// Retrieve previous services and preferences
const getClientHistoryResult = await salon.getClientHistory({ clientId: 'client-abc' })

// Check appointment availability
const findAvailableSlotsResult = await salon.findAvailableSlots({ status: 'active' })
