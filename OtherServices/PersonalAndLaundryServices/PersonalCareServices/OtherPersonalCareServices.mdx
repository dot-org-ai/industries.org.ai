...
```typescript
import { groomBeauty } from '@headlessly/groom-beauty'

const studio = groomBeauty()

// Retrieve previous services and notes
const getClientHistoryResult = await studio.getClientHistory({ clientId: 'client-abc' })

// Check appointment availability
const findAvailableSlotsResult = await studio.findAvailableSlots({ status: 'active' })
