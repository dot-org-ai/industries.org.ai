...
| chemicalDepleted | Chemical supply fell below threshold |
| waterReclaimReachedCapacity | Reclaim tank requires attention |
...
carwash.chemicalDepleted(async ({ chemicalType, currentLevel }) => {
  if (currentLevel < 10) {
